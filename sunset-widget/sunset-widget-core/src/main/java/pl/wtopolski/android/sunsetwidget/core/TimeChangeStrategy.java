...
public enum TimeChangeStrategy {
	NONE {
		@Override
    ...
    private static boolean isEuropeanSummerTime(Date selectedDay) {
    ...
    private static Date getLastSundayInMonth(int month) {
    ...
    private static Date addHour(Date time, int count) {
    	TimePackageCreator creator = new TimePackageCreator();
        Calendar calendar = creator.prepareCalendar();
