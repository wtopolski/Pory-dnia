...
public class TimePackageCreator {
	...
	public TimePackage prepareTimePackage(final Calendar calendar, final TimeLocation location) {
		...
		TimeData<Calendar> forSelectedDay = createTimeDataCalendar(year, month, day, location);
		...
		TimeData<Calendar> forShortestDay = createTimeDataCalendar(year, 12, 21, location);
		...
		TimeData<Calendar> forLongestDay = createTimeDataCalendar(year, 6, 21, location);
	...
	private TimeData<Calendar> createTimeDataCalendar(final int year, final int month, final int day, final TimeLocation location) {
		TimeData<Double> threePack = createTimeDataDouble(year, month, day, location);
	...
	private TimeData<Double> createTimeDataDouble(final int year, final int month, final int day, final TimeLocation location) {
